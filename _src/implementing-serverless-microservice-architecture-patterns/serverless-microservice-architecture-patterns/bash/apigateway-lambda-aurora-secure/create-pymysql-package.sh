...
# Run with sudo ./create-pymysql-package.sh if get Permission denied
...
rm ../../lambda_aurora_secure/pymysql -R || true
mv ~/tmp/lambda_package/lib/python2.7/site-packages/pymysql ../../lambda_aurora_secure