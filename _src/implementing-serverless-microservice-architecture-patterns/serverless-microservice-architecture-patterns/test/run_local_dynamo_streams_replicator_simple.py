...
"""
import json
from lambda_dynamo_replicator.dynamo_to_dynamo_replicator_simple import lambda_handler
...
def main():
    ...
    with open('../sample_data/dynamo-streams-user-visits-sam.json', 'r') as sample_request:
